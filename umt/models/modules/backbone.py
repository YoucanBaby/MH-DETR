...
class UmtV4Backbone(nn.Module):
    ...
    def forward(self, vid, txt, vid_mask, txt_mask):
        ...
        # vid_before_dec = F.normalize(self.contrastive_vid_ffn(vid.permute(1, 0, 2)), p=2, dim=-1)
        # qry_before_dec = F.normalize(self.contrastive_qry_ffn(qry.permute(1, 0, 2)), p=2, dim=-1)
        # return vid_before_dec, qry_before_dec, qry, vg_qry  
